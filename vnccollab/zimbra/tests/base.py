...
from vnccollab.zimbra.testing import VNCCOLLAB_ZIMBRA_INTEGRATION_TESTING, \
    VNCCOLLAB_ZIMBRA_FUNCTIONAL_TESTING
...
class BaseTestCase(unittest.TestCase):
    ...
    def login(self, user_name=TEST_USER_NAME, password=TEST_USER_PASSWORD):
        ...
        browser.getControl(name='__ac_password', index=0).value = \
            TEST_USER_PASSWORD
...
class IntegrationTestCase(BaseTestCase):
    ...
    layer = VNCCOLLAB_ZIMBRA_INTEGRATION_TESTING


class FunctionalTestCase(BaseTestCase):
    """Base class for functional tests."""

    layer = VNCCOLLAB_ZIMBRA_FUNCTIONAL_TESTING
